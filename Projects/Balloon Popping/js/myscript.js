...
var balloon24 = document.getElementById("balloon24");
var balloon25 = document.getElementById("balloon25");
var balloon26 = document.getElementById("balloon26");
var balloon27 = document.getElementById("balloon27");
...
function balloonPopper(balloonVariable) {
    ...
    function popBalloon() {
        //if it is popped then clear its text
        if(balloonVariable.style.background === "none"){
            balloonVariable.innerText = "";
        
        } else { //otherwise write pop and clear its background
...
balloonPopper(balloon25);
balloonPopper(balloon26);
balloonPopper(balloon27);
...
function noBalloons() {
    ...
    let condition = balloon0.style.background === "none" && balloon1.style.background === "none" &&
    balloon0.style.background === "none" && balloon1.style.background === "none" &&
    ...
    balloon24.style.background === "none" && balloon25.style.background === "none" &&
    balloon26.style.background === "none" && balloon27.style.background === "none";

    if(condition) { //if the background of all elements is none
